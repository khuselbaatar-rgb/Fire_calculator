...
// Доор 3 арматур (булгийн өнцөгт + дунд)
const as1Pos = [
[ox + bs/4, oy + hs - c1s ],
[ox + bs/2, oy + hs - c1s ],
[ox + 3*bs/4, oy + hs - c1s ],
...
// Дээр 3 арматур + Хажуу 2 арматур (зүүн гол дээр доор)
const as2Pos = [
[ox + bs/4, oy + c1s ], // дээр зүүн
[ox + bs/2, oy + c1s ], // дээр дунд
[ox + 3*bs/4, oy + c1s ], // дээр баруун
[ox + c1s, oy + c1s ], // хажуу дээр
[ox + c1s, oy + hs - c1s ], // хажуу доор
];
...
svg += `<defs> <pattern id="burnt" patternUnits="userSpaceOnUse" width="8" height="8" patternTransform="rotate(45)"> <rect width="8" height="8" fill="#ff7a1a"/> <rect width="4" height="8" fill="#5a2a08"/> </pattern> </defs>`;
